...
| [macos-fskit.md](macos-fskit.md) | FSKit viability? | Not testable in this environment; scaffold + requirements recorded. |
| [windows-projfs.md](windows-projfs.md) | ProjFS viability? | Distinct architecture; not testable here; `autocrlf=true` system default already surfaced via CI. |
